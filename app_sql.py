...
def predict():
    ...
    print(prediction)                                                                                                                                                                                              
       ...
       # return render_template('index1.html',prediction_text='This is not a Phishing Website')
        ...
        # If URL is not present in dataset
    if prediction.size == 0:
        return render_template('index1.html', prediction_text='This URL is not present in the dataset')

    # If URL is predicted as a phishing website
    elif prediction[0] == 1:
        return render_template('index1.html', prediction_text='This is a Phishing Website')

    # If URL is predicted as not a phishing website
    else:
        return render_template('index1.html', prediction_text='This is not a Phishing Website')
